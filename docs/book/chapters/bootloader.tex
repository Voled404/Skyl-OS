...
By now it should be clear that the addresses used in Real Mode refer to physical addresses. This hinders us from protecting
memory and defining its owenership because no process is prohibitted form accessing any memory segments. Virtual memory
will be discussed later on this book but a brief explaination of how it helps with owenership is given just to clarify 
why physical addressing is limiting.
...
totally different physical addresses, rendering both unable to access eachothers' memory.
